        ...
        <div class="row g-5">
          ...
          <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
            <div class="h-100">
              ...
              <p>
                Fondée en 1996, la société Ogin est spécialisée dans la distribution des équipements industriels, des E.P.I, et des produits de manutention et levage.
                Notre équipe, constituée de quinze personnes, est formée pour répondre aux besoins de ses clients et leur proposer en plus des produits, des solutions techniques accompagnant leur développement.
              </p>
              <p class="mb-4">
                Notre offre produit est composée d'une multitude de cartes, toutes d'origine Européenne, ayant une renommée mondiale et répondant aux standards internationaux
                Avec nos deux magasins au coeur de Casablanca et un dépôt à Ain Sébaa, nous offrons à nos clients plus de 15.000 références produits, avec la possibilité de livrer sur tout le territoire national.
              </p>
                ...
                <div class="row g-4">
                  ...
                  <div class="col-sm-4 d-flex wow fadeIn" data-wow-delay="0.3s">
                    <i
                      class="fa fa-check fa-2x text-primary flex-shrink-0 me-3"
                    ></i>
                    <h6 class="mb-0">Professionnels vérifiés</h6>
                  </div>
                  <div class="col-sm-4 d-flex wow fadeIn" data-wow-delay="0.5s">
                    <i
                      class="fa fa-check fa-2x text-primary flex-shrink-0 me-3"
                    ></i>
                    <h6 class="mb-0">Qualité du produit</h6>
                  </div>
                </div>
              </div>
            </div>
