...
if(isset($_POST['add_produitt'])){
  $p_datail = $_POST['p_detail'];
   ...
   $insert_query = mysqli_query($conn, "INSERT INTO `produit`(detail,nom, image, prix) VALUES('p_detail','$p_name', '$p_image', '$p_price')") or die('query failed');
...
if(isset($_GET['delete'])){
  ...
  $delete_query = mysqli_query($conn, "DELETE FROM `produit` WHERE id = $delete_id ") or die('query failed');
  if($delete_query){
...
if(isset($_POST['update_product'])){
  ...
  $update_query = mysqli_query($conn, "UPDATE `produit` SET detail ='$update_p_detail', nom = '$update_p_nom', image = '$update_p_image' , prix = '$update_p_prix' WHERE id = '$update_p_id'");
...
<body>
    ...
    <section id="product1" class="section-1">
        <form action="" method="post" class="add-product-form" enctype="multipart/form-data">
          ...
          <input type="text" name="p_detail" placeholder="enter the product detail" class="box" required>
        ...
        ?>
            <div class="pro">
                <img src="img/ANTICHUT/<?php echo $row['image']; ?>">
                <div class="des">
                ...
                <a href="ANTICHUT.php?delete=<?php echo $row['id']; ?>" class="delete-btn" onclick="return confirm('are your sure you want to delete this?');"><i class="fa-solid fa-trash" id="cartt"></i></a>
                <a href="ANTICHUT.php?edit=<?php echo $row['id']; ?>"><i class="fa-solid fa-cart-plus " id="cart"></i></a>
            </div>
            <?php
            };    
            }else{
         ...
         ?>
           <div class="pro">
                <img src="img/ANTICHUT/NUSL4ECO.png" alt="">
                <div class="des">
                    <span>Harnais De Securite <u>NUSL4ECO</u></span>
                    <h5>NUS61E-BA</h5>
                    <h4>$250</h4>
                    <p>demande de devis</p>
                </div>
               <a href="#"><i class="fa-solid fa-trash" id="cartt"></i></a>
                <a href="#"><i class="fa-solid fa-cart-plus " id="cart"></i></a>
            </div>
            <div class="pro">
                <img src="img/ANTICHUT/NUSL2ECO.png" alt="" >
                <div class="des">
                    <span>Harnais De Securite <u>NUSL2ECO</u></span>
                    <h5>NUS61E-BA</h5>
                    <h4>$340</h4>
                    <p>demande de devis</p>
                </div>
            ...
            <div class="pro">
                <img src="img/ANTICHUT/NUS55.jpg" alt="">
                <div class="des">
                    <span>Harnais De Securite <u>NUS55</u></span>
                    <h5>NUS61E-BA</h5>
                    <h4>$100</h4>
                    <p>demande de devis</p>
                </div>
            ...
            <div class="pro">
                <img src="img/ANTICHUT/NUS132-ALT’O.jpg" alt="">
                <div class="des">
                    <span>Harnais De Securite <u>NUS132-ALT'O</u></span>
                    <h5>NUS61E-BA</h5>
                    <h4>$100</h4>
                    <p>demande de devis</p>
                </div>
                <a href="#"><i class="fa-solid fa-trash" id="cartt"></i></a>
                <a href="#"><i class="fa-solid fa-cart-plus " id="cart"></i></i></a>
            </div>
            <div class="pro">
                <img src="img/ANTICHUT/NCE1ECO.jpg" alt="">
                <div class="des">
                    <span>Harnais De Securite <u>NCE1ECO</u></span>
                    <h5>NUS61E-BA</h5>
                    <h4>$100</h4>
                    <p>demande de devis</p>
                </div>
            ...
            <div class="pro">
                <img src="img/ANTICHUT/NELUS124.jpg" alt="">
                <div class="des">
                    <span>Harnais De Securite <u>NELUS124</u></span>
                    <h5>NUS61E-BA</h5>
                    <h4>$100</h4>
                    <p>demande de devis</p>
                </div>
            ...
            <div class="pro">
                <img src="img/ANTICHUT/NELUS126.jpg" alt="">
                <div class="des">
                    <span>Harnais De Securite <u>NELUS126</u></span>
                    <h5>NUS61E-BA</h5>
                    <h4>$100</h4>
                    <p>demande de devis</p>
                </div>
   ...
   if(isset($_GET['edit'])){
      $edit_id = $_GET['edit'];
      $edit_query = mysqli_query($conn, "SELECT * FROM `produit` WHERE id = $edit_id");
